...
@Component({
  ...
  imports: [
    ...
    ConverterItemSkeletonComponent,
  ],
...
export class GoldCalculatorComponent {
  ...
  goldValues$ = this.requestClass.allItemsList.pipe(
    map((items) => ({
      gram18: items.find((i) => i.id === '5000217'),
      gram24: items.find((i) => i.id === '5000219'),
      mini: items.find((i) => i.id === '5000220'),
      futures: items.find((i) => i.id === '5000227'),
      mesghal: items.find((i) => i.id === '5000223'),
      ounce: items.find((i) => i.id === '6000244'),
    })),
  ...
  goldValueComputed$ = combineLatest([
    ...
    map(([goldValues, currentGoldType, changedByUser, userValue]) => {
      ...
      switch (currentGoldType) {
        ...
        case 2:
          const meltedValue = mesghalToGramMoney(
            goldValues.futures?.tomanStringPrice!,
          );
  ...
  mainGoldValue$ = combineLatest([
    ...
    map(([value, weightValue]) => {
      return commafy(
        priceToNumber(weightValue || '1') * priceToNumber(value! || '0') || 0,
      );
    }),
  );

  totalWageValue$ = combineLatest([this.mainGoldValue$, this.wageValue$]).pipe(
    map(([goldValue, wageValue]) => {
      return commafy(
        (priceToNumber(wageValue) * priceToNumber(goldValue)) / 100 || 0,
      );
    }),
  );

  totalTaxValue$ = combineLatest([this.mainGoldValue$, this.taxValue$]).pipe(
    map(([goldValue, taxValue]) => {
      return commafy(
        (priceToNumber(goldValue) * priceToNumber(taxValue)) / 100 || 0,
      );
    }),
  );
  ...
  totalGoldValue$ = combineLatest([
    ...
    map(([goldValue, wageValue, taxValue, profitValue]) => {
      return commafy(
        priceToNumber(goldValue) +
          priceToNumber(wageValue) +
          priceToNumber(taxValue) +
          priceToNumber(profitValue) || 0,
      );
    }),
  );
    ...
    this.weightValue$.subscribe((value) => {
      switch (this.currentOunceType()) {
        ...
        case 0:
          ...
          currentGramTypes[1] = {
            ...currentGramTypes[1],
            value: commafy(trimDecimal(ounceValue, 3)),
          };
          currentGramTypes[2] = {
            ...currentGramTypes[2],
            value: commafy(trimDecimal(mesghalValue, 4)),
          };
          currentGramTypes[3] = {
            ...currentGramTypes[3],
            value: commafy(trimDecimal(sutValue, 0)),
          };
          currentGramTypes[4] = {
            ...currentGramTypes[4],
            value: commafy(trimDecimal(caratValue, 2)),
          };
        ...
        case 1:
          ...
          ounceCurrentTypes[0] = {
            ...ounceCurrentTypes[0],
            value: commafy(trimDecimal(ounceGramValue, 3)),
          };
          ounceCurrentTypes[2] = {
            ...ounceCurrentTypes[2],
            value: commafy(trimDecimal(ounceMesghalValue, 4)),
          };
          ounceCurrentTypes[3] = {
            ...ounceCurrentTypes[3],
            value: commafy(trimDecimal(ounceSutValue, 0)),
          };
          ounceCurrentTypes[4] = {
            ...ounceCurrentTypes[4],
            value: commafy(trimDecimal(ounceCaratValue, 2)),
          };
        ...
        case 2:
          ...
          mesghalCurrentTypes[0] = {
            ...mesghalCurrentTypes[0],
            value: commafy(trimDecimal(mesghalGramValue, 3)),
          };
          mesghalCurrentTypes[1] = {
            ...mesghalCurrentTypes[1],
            value: commafy(trimDecimal(mesghalOunceValue, 3)),
          };
          mesghalCurrentTypes[3] = {
            ...mesghalCurrentTypes[3],
            value: commafy(trimDecimal(mesghalSutValue, 0)),
          };
          mesghalCurrentTypes[4] = {
            ...mesghalCurrentTypes[4],
            value: commafy(trimDecimal(mesghalCaratValue, 2)),
          };
        ...
        case 3:
          ...
          sutCurrentTypes[0] = {
            ...sutCurrentTypes[0],
            value: commafy(trimDecimal(sutGramValue, 3)),
          };
          sutCurrentTypes[1] = {
            ...sutCurrentTypes[1],
            value: commafy(trimDecimal(sutOunceValue, 3)),
          };
          sutCurrentTypes[2] = {
            ...sutCurrentTypes[2],
            value: commafy(trimDecimal(sutMesghalValue, 4)),
          };
          sutCurrentTypes[4] = {
            ...sutCurrentTypes[4],
            value: commafy(trimDecimal(sutCaratValue, 2)),
          };
        ...
        case 4:
          ...
          currentOunceTypes[0] = {
            ...currentOunceTypes[0],
            value: commafy(trimDecimal(caratGramValue, 3)),
          };
          currentOunceTypes[1] = {
            ...currentOunceTypes[1],
            value: commafy(trimDecimal(caratOunceValue, 3)),
          };
          currentOunceTypes[2] = {
            ...currentOunceTypes[2],
            value: commafy(trimDecimal(caratMesghalValue, 4)),
          };
          currentOunceTypes[3] = {
            ...currentOunceTypes[3],
            value: commafy(trimDecimal(caratSutValue, 0)),
          };
  ...
  onWeightInputChange(event: Event) {
    ...
    this.weightValueSubject.next(
      commafy(priceToNumber(weightValue) || 0) || '0',
    );
  }
  ...
  ngOnInit() {
    ...
    this.route.queryParamMap.subscribe((params) => {
      ...
      const gold =
        params.get('gold') !== null ? Number(params.get('gold')) : null;

      const unit =
        params.get('unit') !== null ? Number(params.get('unit')) : null;
